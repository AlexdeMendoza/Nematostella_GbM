...
histone_marks = Script to compare histone modification levels between slow and fast DMRs
rnaseq = Scripts to quantify RNA-seq counts
populations_methylation = Script to identify DMRs in different Nematostella populations compared to the DMSO treated samples
